...
## 6.7.2 Important Hosting Configuration
...
## 6.7.3.1 Vercel configuration tips
...
## 6.7.6 Deploying on GitHub Pages
...
## 6.7.6.1 Adding a custom domain to GitHub pages
...
## 6.7.6.2 Automated deployment to GitHub pages with push-dir

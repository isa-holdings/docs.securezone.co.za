# 5.10 Implemetations of the GraphQL Spec

5.10.1 [urql](https://formidable.com/open-source/urql/docs/)
5.10.2 [Relay The GraphQL client that scales](https://relay.dev/)
5.10.3 [prapthQL Reuest](https://github.com/prisma-labs/graphql-request)
5.10.4 [Vue Auth](https://bestofvue.com/repo/websanova-vue-auth-vuejs-authentication-authorization)
5.10.5 [Laravel-Vue SPA](https://reposhub.com/php/web-frameworks/cretueusebiu-laravel-vue-spa.html)
5.10.6 [Typescript GraphQL](https://github.com/babyfish-ct/graphql-ts-client)

## 5.10.7 Lighthouse GraphQL Passport Auth [https://github.com/joselfonseca/lighthouse-graphql-passport-auth](https://github.com/joselfonseca/lighthouse-graphql-passport-auth)

After investigating what seemed to be an endless sea of people creating framework after framwork and everyone posting ready to do auth solutions, I decided to go with something that is maintained by the Laravel team themselves, and that does not require me to install yet another someone's node.js module or php package or UI framwork or JS framework or data modeling framwork or someone's data storage or caching laying or transport laying or translation layer or ajax class or css pre-presessor or whatever else the people are comming up with.

[Lighthouse GraphQL Passport Auth](https://lighthouse-php-auth.com/docs/customization/#customize-schema)

There are a few steps to follow but it is nothing funny or someone trying to reinvent anything, this solution uses the following

## 5.10.7.1 Compatibility

- Larave 7 or 8
- Laravel Passport
- Laravel Lighthouse
- A new GraphQL schema (Prepared Statements to sort of put it in SQL terms)
- CORS Settings

## 5.10.7.2 What is provides out of the box

- It gives us stateless auth with a token,
- Supports OAuth1 and OAuth2
- User rights
- Supports Login with Google or Facebook (OAuth
- Can interface with other laravel apps or api's
- Can me a transport layer
- Can work as Restfull or GraphQL
- Can interface with React, Vue and all the big frontend frameworks
- Supports caching
- Suports Redis and Memcache

## 5.10.7.3 Installation and configuration
...
## 5.10.7.5 Testing a protected query
